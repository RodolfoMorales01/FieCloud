<div class="row">
   	<div class="col-lg-12">
        <h1 class="page-header"><i class="fa fa-cloud" aria-hidden="true">&nbsp;</i>Mi unidad</h1>
    </div>
</div>
	...
	<div class="modal fade" id="myModalfolder" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?= base_url() ?>index.php/cinicio/CrearDir" method="POST" enctype="multipart/form-data">
                    <center>
                        <table>
                            <tr>
                ...
                <tr>
                    <td style="width: 98px;">
                        <center>
                            ...
                            <a href="<?php echo base_url();?>index.php/cinicio/compartir/<?php echo $key->idarchivos?>" class="btn btn-sm btn-warning" onclick="Compartir()">
                                <i class="fa fa-share-alt" aria-hidden="true" title="Compartir Archivo"></i>
                            </a>
